...
the respective online repository where gagepy is hosted.
...
Look through the issues page of the respective online repository where gagepy is hosted for bugs.
Anything tagged with "bug" is open to whoever wants to implement it.

Implement Features
~~~~~~~~~~~~~~~~~~

Look through the issues page of the respective online repository where gagepy is hosted for features.
Anything tagged with "feature" is open to whoever wants to implement it.

Write Documentation
~~~~~~~~~~~~~~~~~~~

gagepy could always use more documentation, whether as part of the
official gagepy docs or in docstrings.
...
Ready to contribute? Here's how to set up `gagepy` for local development.

1. Fork the `gagepy` repo.
2. Clone your fork locally::

    $ git clone <remote url to your forked version of gagepy>
...
If you have conda_ installed, this is how you set up your fork for local development on Linux or Mac OS X::
    ...
    $ conda create --name gagepy
    $ source activate gagepy
    $ cd <your-path-to-gagepy-project/
    $ python setup.py develop
...
6. Commit your changes and push your branch to the respective online repository where gagepy is hosted::

    $ git add .
    $ git commit -m "Your detailed description of your changes."
    $ git push origin name-of-your-bugfix-or-feature

7. Submit a pull request through the respective online repository website where gagepy is hosted.
